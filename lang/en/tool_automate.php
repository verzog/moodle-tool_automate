...
$string['restorefiles_help'] = 'Select one or more course backup (.mbz) files found in the source directory. Each selected file is restored into a brand-new course in the target category; existing courses are never overwritten.';
