...
$string['coursescope_enrolled'] = 'For every course the user is enrolled in';
$string['coursescope_help'] = 'Off: report only the matched users. One course: every matched user gets one row with progress in the chosen course. Enrolled: one row per user per course they are enrolled in.';
$string['coursescope_none'] = 'Off - just the matched users';
$string['coursescope_one'] = 'For one course';
