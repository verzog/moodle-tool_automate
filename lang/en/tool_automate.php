...
$string['act_course_delete'] = 'Delete the course (permanent)';
$string['act_course_delete_desc'] = 'Permanently delete every matched course';
...
$string['coursedeletewarning'] = 'WARNING: this action permanently deletes every course matched by the rule. Deletion cannot be undone. Use Preview first to confirm exactly which courses would be removed.';
